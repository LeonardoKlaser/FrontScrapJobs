      ...
      <CardContent className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="space-y-0.5 flex-1">
            ...
            <p className="text-sm text-muted-foreground">Receba notificações quando novas vagas forem encontradas</p>
          </div>
          <Switch
            id="email-vagas"
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5 flex-1">
            ...
            <p className="text-sm text-muted-foreground">Receba um resumo das suas atividades toda semana</p>
          </div>
          <Switch
            id="resumo-semanal"
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5 flex-1">
            ...
            <p className="text-sm text-muted-foreground">Receba alertas sobre atividades suspeitas na sua conta</p>
          </div>
          <Switch
