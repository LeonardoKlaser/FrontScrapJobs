...
export default function AdminSitesListPage() {
  ...
  return (
    <>
      <AppPageHeader title={t('pageTitle.adminSites', { ns: 'common' })}>
        <Button onClick={() => navigate(PATHS.app.addNewSite)} variant="glow" size="sm">
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div className="relative max-w-sm w-full">
            ...
            <Input
              type="text"
              placeholder={t('adminSites.searchPlaceholder', {
                defaultValue: 'Buscar por nome...'
              })}
              value={search}
