          ...
          <div className="max-w-md mx-auto mb-12">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${
                filter == "subscribed" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:text-foreground"
              }`}
            >
              Inscrito
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium transition-all relative ${
                filter == "not_subscribed" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:text-foreground"
              }`}
            >
              Não inscrito
