          ...
          {isSuccess && (
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure as informações fundamentais do site de empregos</CardDescription>
              </CardHeader>
            ...
            {formData.scraping_type === "CSS" && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Configure os seletores CSS para extrair dados das páginas</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <div className="flex items-center space-x-2">
                        <Label htmlFor="job_list_item_selector">Seletor do Item da Lista de Vagas</Label>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center space-x-2">
                        <Label htmlFor="next_page_selector">Seletor do Botão 'Próxima Página'</Label>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleInputChange("job_description_selector", e.target.value)}
                      />
                    </div>

                    <div className="space-y-2">
                      <div className="flex items-center space-x-2">
                        <Label htmlFor="job_requisition_id_selector">Seletor do ID de Requisição</Label>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleInputChange("job_requisition_id_selector", e.target.value)}
                      />
                    </div>
                  </div>
                </CardContent>
            ...
            {formData.scraping_type === "API" && (
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="api_payload_template">Corpo da Requisição (Payload Template)</Label>
                    <Textarea
